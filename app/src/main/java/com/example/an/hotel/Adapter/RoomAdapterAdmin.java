...
public class RoomAdapterAdmin extends RealmBaseAdapter<roomObj> implements ListAdapter {
    private AdminRoomList activityAdmin;
    private static class ViewHolder {
        TextView roomName;
    }

    RoomAdapterAdmin(AdminRoomList activityAdmin, OrderedRealmCollection<roomObj> data) {
        super(data);
