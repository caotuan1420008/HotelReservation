...
public class MainUserAdapter extends RealmBaseAdapter<roomObj> implements ListAdapter {
    private MainActivity activity;
    private static class ViewHolder {
        TextView roomName;
    }

    MainUserAdapter(MainActivity activity, OrderedRealmCollection<roomObj> data) {
        super(data);
